...
const Navbar = () => {
  ...
  const links = (
    <>
      ...
      <li>
        <NavLink to="/addjob">Available Cars</NavLink>
      </li>
      <li>
        <NavLink to="/myApplication">Add Car</NavLink>
      </li>
      <li>
        <NavLink to="/myPostedJob">My Cars</NavLink>
      </li>
      <li>
        <NavLink to="/myPostedJob">My Bookings</NavLink>
      </li>
